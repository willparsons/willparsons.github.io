            ...
            <div class="w-full h-full flex flex-row justify-center items-center lg:px-64">
                <div class="w-full">
                    <div class="flex mb-4 justify-between">
                        ...
                        <div class="flex gap-4">
                            <a
                                href="https://github.com/willparsons"
                    ...
                    <p class="text-lg my-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur a varius sem. Ut accumsan eu
                        sem vel dignissim. Maecenas vitae neque nisi. Donec a ligula lacus. Praesent eget urna eget
                        nulla sagittis dictum ut eget odio. Donec quis efficitur elit, nec pretium eros. Lorem ipsum
